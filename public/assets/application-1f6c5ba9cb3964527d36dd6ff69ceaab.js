...
(function() {
  ...
  jQuery(function() {
    return $("#book_isbn10").blur(function() {
      if (Isbn.validNumber(this.value)) {
        return $("#credit_card_number_error").text("Valid ISBN");
      } else {
        return $("#credit_card_number_error").text("Invalid ISBN");
      }
    });
  });
